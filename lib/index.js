...
const grpc_caller_1 = require("grpc-caller");
...
function getGraphqlSchemaFromGrpc({ endpoint, protoFile, serviceName, packageName, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const client = grpc_caller_1.default(endpoint, path.resolve(__dirname, protoFile), serviceName, null, {
            'grpc.max_send_message_length': -1,
            'grpc.max_receive_message_length': -1,
        });
        const { nested } = yield protobuf_1.getPackageProtoDefinition(protoFile, packageName);
